...
impl<'a, S: StoreConnection + 'a> SimpleEvaluator<S> {
    ...
    pub fn evaluate_select_plan<'b>(
        ...
        plan: &'b PlanNode,
        variables: &[Variable],
        service_handler: Option<ServiceHandler<'b>>
    ...
    fn eval_expression<'b>(
        ...
        match expression {
            ...
            PlanExpression::MD5(arg) => self.hash::<Md5>(arg, tuple, service_handler),
            PlanExpression::SHA1(arg) => self.hash::<Sha1>(arg, tuple, service_handler),
            PlanExpression::SHA256(arg) => self.hash::<Sha256>(arg, tuple, service_handler),
            PlanExpression::SHA384(arg) => self.hash::<Sha384>(arg, tuple, service_handler),
            PlanExpression::SHA512(arg) => self.hash::<Sha512>(arg, tuple, service_handler),
